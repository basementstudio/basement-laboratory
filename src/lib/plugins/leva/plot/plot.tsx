import { Components, useInputContext, useValues } from 'leva/plugin'
import React, { useEffect, useRef } from 'react'

import { PlotCanvas } from './plot-canvas'
import type { PlotProps } from './plot-types'
import { Container, SyledInnerLabel } from './styled-plot'
...
export function Plot() {
  ...
  useEffect(() => {
    ...
    console.log('UPDATE!', value?.__symbols, scope)
  }, [scope, onUpdate])
