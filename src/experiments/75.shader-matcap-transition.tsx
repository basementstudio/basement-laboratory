...
const fragment = /*glsl*/ `
    ...
    void main() {
      ...
      vec3 reflected = reflect(viewDir, vViewNormal);
      float m = 2.8284271247461903 * sqrt(reflected.z + 1.0);
      vec2 matUv = reflected.xy / m + 0.75;
      vec4 matcapColor = texture2D(uMatcap, matUv);
      ...
      vec4 final = mix(matcapColor, vec4(animateColor, 1.0), step);
